...
Scene* New_GameclearScene(int label, CharacterStatus *status) {
    ...
    GameclearScene *data = (GameclearScene*)malloc(sizeof(GameclearScene));
    
    data->image = al_load_bitmap("assets/image/gameclear.png");
    ...
    pObj->Update = GameclearScene_update;
    pObj->Draw = GameclearScene_draw;
    pObj->Destroy = GameclearScene_destroy;
...
void GameclearScene_draw(Scene *self) {
    GameclearScene *data = (GameclearScene*)self->pDerivedObj;
