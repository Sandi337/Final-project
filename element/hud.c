...
void Draw_HUD(Character *chara, ALLEGRO_FONT *font, int screen_width) {
    ...
    float hp_ratio = (float)chara->health / MAX_HEALTH;
    float en_ratio = (float)chara->energy / MAX_ENERGY;
    float sp_ratio = (float)chara->spirit / MAX_SPIRIT;
    ...
    al_draw_textf(font, al_map_rgb(255, 255, 255), base_x + 5, base_y, 0, "HP: %d / %d", chara->health, MAX_HEALTH);
    ...
    al_draw_textf(font, al_map_rgb(255, 255, 255), base_x + 5, base_y, 0, "Energy: %d / %d", chara->energy, MAX_ENERGY);
    ...
    al_draw_textf(font, al_map_rgb(255, 255, 255), base_x + 5, base_y, 0, "Spirit: %d / %d", chara->spirit, MAX_SPIRIT);
}
